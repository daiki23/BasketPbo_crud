...
public class frmMain extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("FORM Pendaftaran Basekt TSBC");
        ...
        jPanel2.add(rbLaki);
        rbLaki.setBounds(22, 163, 100, 23);
        ...
        rbPerempuan.setBounds(140, 160, 110, 23);
        ...
        jPanel2.add(posisi);
        posisi.setBounds(20, 320, 188, 40);

        jLabel13.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel13.setText("Posisi");
        jPanel2.add(jLabel13);
        jLabel13.setBounds(20, 300, 60, 14);
        ...
        tblData.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "NIS", "NamaSiswa", "JenisKelamin", "Kelas", "Email", "Posisi"
            }
        ) {
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        // TODO add your handling code here:
        if("".equals(txtNIS.getText()) ||  "".equals(txtKelas.getText()) || "".equals(txtNama.getText()) ||  "".equals(posisi.getText()) || "".equals(txtEmail2.getText()))
        {
        ...
        {   
            ...
            String SQL = "INSERT INTO t_siswa (NIS,NamaSiswa,JenisKelamin,Kelas,Email,Posisi)" + "VALUES('" + txtNIS.getText()+"','"+ txtNama.getText()+"','"+ JK +"','"+ txtKelas.getText()+"','"+ txtEmail2.getText()+"','"+ posisi.getText()+"')";
    ...
    private void tblDataMouseClickedMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblDataMouseClickedMouseClicked
        ...
        if(baris!=1){
            ...
            txtEmail2.setText(tblData.getValueAt(baris, 4).toString());
             ...
             posisi.setText(tblData.getValueAt(baris, 5).toString());
    ...
    private void selectData() {
        String kolom[] = {"NIS","NamaSiswa","JenisKelamin","Kelas","Email","Posisi"};
        ...
        try{
            while(rs.next()){
             ...
             String Posisi = rs.getString(6);
                String data[] = {NIS,NamaSiswa,JenisKelamin,Kelas,Email,Posisi};
                dtm.addRow(data);
            }
